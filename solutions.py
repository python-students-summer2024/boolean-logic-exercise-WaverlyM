...
def is_inclement():
    ...
    weather = input('what is the forecast today? ')
    weather = weather.lower()
    if 'rain'in weather or 'snow' in weather or 'sleet' in weather:
        return True
    else: 
        return False
...
def is_typical_new_york_summer():
    ...
    if is_sweltering() and is_humid() is True:
        return True
    else:
        return False
...
def is_cool_and_nice():
    ...
    if is_sweltering() or is_warm() or is_humid() or is_inclement() is True:
        return False
    else:
        return True
